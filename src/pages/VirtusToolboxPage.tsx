            ...
            <div className="bg-white rounded-2xl p-12 shadow-soft border border-neutral-200">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  <div className="w-6 h-6 bg-success-100/30 rounded-full flex items-center justify-center mr-3 mt-1">
              ...
              <div>
                <h4 className="text-lg font-semibold mb-4 text-neutral-800">Platforms:</h4>
                <p className="text-neutral-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-success-100/30 rounded-full flex items-center justify-center mx-auto mb-6">
                <Key className="h-8 w-8 text-success-600" />
              </div>
